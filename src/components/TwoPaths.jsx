    ...
    <section id="career-paths" className="section two-paths-section">
      <div className="container">
        ...
        <div className="two-paths__grid">
          ...
          >
            <div className="two-paths__content">
              ...
              <div className="two-paths__support">
            ...
            <div className="two-paths__actions">
              ...
              <a className="btn btn--ghost btn--sm two-paths__tertiary" href="#experience">
                View Experience ↓
              </a>
            </div>
          </motion.div>
          ...
          >
            <div className="two-paths__content">
              ...
              <div className="two-paths__support">
                <div className="two-paths__rate-box">
                  ...
                  <span className="two-paths__rate-value">
                    Consulting engagements starting at $200/hour
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="two-paths__actions">
              ...
              <a className="btn btn--ghost btn--sm two-paths__tertiary" href="#consulting">
                Quick Summary ↓
              </a>
            </div>
          </motion.div>
